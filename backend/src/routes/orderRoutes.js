...
router.post('/verify-payment/:orderId', verifyPaymentValidation, orderController.verifyPayment);

// GET /api/orders - Get user's orders
router.get('/', orderController.getUserOrders);

// GET /api/orders/:orderId - Get specific order
router.get('/:orderId', getOrderByIdValidation, orderController.getOrderById);

// PUT /api/orders/:orderId/cancel - Cancel order
router.put('/:orderId/cancel', cancelOrderValidation, orderController.cancelOrder);
...
router.put('/:orderId/status', authorize('admin'), updateOrderStatusValidation, orderController.updateOrderStatus);
